...
setanticlockwise:
    ;逆时针转
    cmp byte ptr[bx + 3], 1; 判断步数为正还是负数, 正数为0, 负数为1
    jz stepinc; 如果是负数, 步数+1
    cmp stepcount, 0; 正数, 判断步数为'0000', 下一步应该变为'1001', 即+0->-1
...
setclockwise:
    ...
    ; 说明是负数
    cmp setcount, 1; 判断是不是'1001',下一步应该变为'0000'
